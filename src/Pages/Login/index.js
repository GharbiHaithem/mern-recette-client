                                ...
                                <form className='d-flex flex-column gap-10 '  onSubmit={formik.handleSubmit}>
                                   ...
                                   <Link style={{ textDecoration: 'none', textAlign: 'end' ,marginBottom:'80px' }}>Forgot Password ?</Link>
                                    ...
                                    <div className='bloc-btn gap-10 flex-column d-flex'>
                                        <Link className='w-100 d-flex align-items-center   justify-content-center gap-30   button  border border-1  p-2'  to={`${base_url}/auth/google/callback`} onClick={handleLogin}><FcGoogle  /><span  className='text-light'   > SIGN IN WITH GOOGLE</span></Link>
